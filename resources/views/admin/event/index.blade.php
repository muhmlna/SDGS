    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
                <h3 class="card-title">Tabel Data event</h3>
                <a href="{{ route('admin.event.create') }}" class="btn-sm btn-primary">Tambah
                    event</a>
            </div>
                                ...
                                <td class="manage-row">
                                    @if (auth()->user()->roles_id == 1)
                                        ...
                                        <a role="button" class="btn-sm btn-danger delete-button" data-bs-toggle="modal"
                                            data-bs-target=".bd-example-modal-sm{{ $event->id }}">
                                            Hapus
                                        </a>
                                        <!-- Modal -->
                                        <div class="modal fade bd-example-modal-sm{{ $event->id }}" tabindex="-1"
