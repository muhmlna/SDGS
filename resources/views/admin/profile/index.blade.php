    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
                <h3 class="card-title">Tabel Data profile</h3>
                <a href="{{ route('admin.profile.create') }}" class="btn-sm btn-primary">Tambah
                    profile</a>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="manage-row">
                                    @if (auth()->user()->roles_id == 1)
                                        <a href="{{ route('admin.profile.show', $profile->id) }}"
                                        ...
                                        <a role="button" class="btn-sm btn-danger delete-button" data-bs-toggle="modal"
                                            data-bs-target=".bd-example-modal-sm{{ $profile->id }}">
                                            Hapus
                                        </a>
                                        <!-- Modal -->
                                        <div class="modal fade bd-example-modal-sm{{ $profile->id }}" tabindex="-1"
